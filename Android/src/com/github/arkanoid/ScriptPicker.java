...
public class ScriptPicker extends ExpandableListActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        final HashMap<String, ArrayList<String>> scripts = (HashMap<String, ArrayList<String>>) getIntent().getSerializableExtra(Sample.SCRIPTS);
    ...
    public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id)
    {
        ...
        setResult(RESULT_OK, getIntent().putExtra(Sample.PICKED_SCRIPT, map.get(SCRIPT)));
        finish();
        return true;
    }
